...
class CSV:
    ...
    def get_transactions(cls, start_date, end_date):
        ...
        if filtered_df.empty:
            ...
            print(
                f"Transaction{start_date.strftime(CSV.FORMAT)} to {end_date.strftime(CSV.FORMAT)}")
...
def add():
    CSV.initialize_csv()
    date = get_date(
        'Enter the date of the transaction (dd-mm-yyyy) or enter for today date: ', allow_default=True)
    amount = get_amount()
...
def main():
    while True:
        ...
        if choice == '1':
            ...
            if input('Do you want to see a plot? (y\n').lower() == 'y':
            ...
            print('Invaled choice Enter 1,2 or 3')
